...
export const gearItems: GearItem[] = [
  ...
  },
  {
    ...
    products: [
      ...
      {
        name: "Adidas Control 3.3 Racket Bag",
        brand: "Adidas",
        price: "~£55",
        url: pm("collections/bags"),
      ...
      {
        name: "Wilson Super Tour Padel Bag",
        brand: "Wilson",
        price: "~£65",
        url: pm("collections/bags"),
